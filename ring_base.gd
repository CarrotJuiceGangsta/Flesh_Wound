...
var spawn_rings_once = true

func _process(_delta: float) -> void:
	if in_shop == true and Game.shop_rolled == true and spawn_rings_once == true:
		spawn_rings()
		spawn_rings_once = false
		...
		if area.owner != inventory:
			if ring_inventory_slot == 0:
				if area.owner.ring_inventory_slot == 1:
					ring = Game.inv_slot_2
					Game.inv_slot_2 = Game.inv_slot_1
					Game.inv_slot_1 = ring
				if area.owner.ring_inventory_slot == 2:
					ring = Game.inv_slot_3
					Game.inv_slot_3 = Game.inv_slot_1
					Game.inv_slot_1 = ring
				if area.owner.ring_inventory_slot == 3:
					ring = Game.inv_slot_4
					Game.inv_slot_4 = Game.inv_slot_1
					Game.inv_slot_1 = ring
			if ring_inventory_slot == 1:
				if area.owner.ring_inventory_slot == 0:
					ring = Game.inv_slot_1
					Game.inv_slot_1 = Game.inv_slot_2
					Game.inv_slot_2 = ring
				if area.owner.ring_inventory_slot == 2:
					ring = Game.inv_slot_3
					Game.inv_slot_3 = Game.inv_slot_2
					Game.inv_slot_2 = ring
				if area.owner.ring_inventory_slot == 3:
					ring = Game.inv_slot_4
					Game.inv_slot_4 = Game.inv_slot_2
					Game.inv_slot_2 = ring
			if ring_inventory_slot == 2:
				if area.owner.ring_inventory_slot == 0:
					ring = Game.inv_slot_1
					Game.inv_slot_1 = Game.inv_slot_3
					Game.inv_slot_3 = ring
				if area.owner.ring_inventory_slot == 1:
					ring = Game.inv_slot_2
					Game.inv_slot_2 = Game.inv_slot_3
					Game.inv_slot_3 = ring
				if area.owner.ring_inventory_slot == 3:
					ring = Game.inv_slot_4
					Game.inv_slot_4 = Game.inv_slot_3
					Game.inv_slot_3 = ring
			if ring_inventory_slot == 3:
				if area.owner.ring_inventory_slot == 0:
					ring = Game.inv_slot_1
					Game.inv_slot_1 = Game.inv_slot_4
					Game.inv_slot_4 = ring
				if area.owner.ring_inventory_slot == 1:
					ring = Game.inv_slot_2
					Game.inv_slot_2 = Game.inv_slot_4
					Game.inv_slot_4 = ring
				if area.owner.ring_inventory_slot == 2:
					ring = Game.inv_slot_3
					Game.inv_slot_3 = Game.inv_slot_4
					Game.inv_slot_4 = ring
...
func spawn_rings():
	if in_shop == false:
		...
		if ring_inventory_slot == 0:
			print("fa")
			ring = Game.shop_slot_1
			position = ring_slot_1_position
		elif ring_inventory_slot == 1:
			print("sh")
			ring = Game.shop_slot_2
			position = ring_slot_2_position
		elif ring_inventory_slot == 2:
			ring = Game.shop_slot_3
			position = ring_slot_3_position
